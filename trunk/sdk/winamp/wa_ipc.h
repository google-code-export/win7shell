/*
** Copyright (C) 1997-2010 Nullsoft, Inc.
**
...
/* (requires Winamp 5.04+)
** SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_NEXT_PLITEM);
**
...
/* (requires Winamp 5.04+)
** SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_PREVIOUS_PLITEM);
**
...
/* (requires Winamp 5.?+)
** wchar_t* fn=(wchar_t*)SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_PLAYING_FILENAME);
...
/* (requires Winamp 5.5+)
** wchar_t* title=(wchar_t*)SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_PLAYING_TITLE);
...
/* (requires Winamp 5.5+)
** In_Module *in_mod=(In_Module*)SendMessage(hwnd_winamp,WM_WA_IPC,(WPARAM)fn,IPC_CANPLAY);
...
/* (requires Winamp 5.57+)
** HMODULE d3dx9 = (HMODULE)SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_D3DX9);
**
...
** IFileTypeRegistrar* registrar = (IFileTypeRegistrar*)SendMessage(hwnd_winamp,WM_WA_IPC,0,IPC_GET_FILEREGISTRAR_OBJECT);
**
